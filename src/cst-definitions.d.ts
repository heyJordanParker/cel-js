...
export interface CoalesceCstNode extends CstNode {
  name: 'coalesce'
  children: CoalesceCstChildren
}

export type CoalesceCstChildren = {
  lhs: ConditionalOrCstNode[]
  Coalesce?: IToken[]
  rhs?: ConditionalOrCstNode[]
}
...
export type AtomicExpressionCstChildren = {
  ...
  Float?: IToken[]
  HexUnsignedInteger?: IToken[]
  HexInteger?: IToken[]
  OctalUnsignedInteger?: IToken[]
  OctalInteger?: IToken[]
  BinaryUnsignedInteger?: IToken[]
  BinaryInteger?: IToken[]
...
export interface ICstNodeVisitor<IN, OUT> extends ICstVisitor<IN, OUT> {
  ...
  coalesce(children: CoalesceCstChildren, param?: IN): OUT
